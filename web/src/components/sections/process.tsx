...
export function Process() {
    ...
    return (
        <section id="como-funciona" className="relative bg-[#0A0E27] py-24 lg:py-32 overflow-hidden">
            {/* Background Details */}
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-[120px]" />
                <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-[120px]" />
            ...
            <div className="relative container mx-auto px-4 md:px-8 z-10">
                ...
                <div ref={containerRef} className="relative max-w-5xl mx-auto">
                    ...
                    <div className="absolute left-8 md:left-1/2 top-0 bottom-0 w-0.5 bg-white/10 hidden md:block -translate-x-1/2">
                        <motion.div
                            ...
                            >
                                ...
                                <div className={cn(
                                    ...
                                    item.highlight
                                        ...
                                        : "bg-[#1a1c1d] border-2 border-[#D4AF37]/30 text-[#D4AF37]"
                                )}>
                                    {item.highlight ? (
                                        ...
                                        <div className="p-8">
                                            ...
                                            <div className="flex items-center gap-3 md:hidden mb-4">
                                                <div className={cn(
                                                    ...
                                                    item.highlight ? "bg-[#D4AF37] text-black" : "bg-white/10 text-[#D4AF37]"
                                                )}>
                                            ...
                                            <p className="text-white/60 text-sm md:text-base leading-relaxed max-w-md mx-auto md:mx-0">
                                                {item.description}
                                            </p>
                                        </div>
                                    </div>
